...
class CFDI
{
     ...
     * @param boolean   $xslt
     */
    public function __construct( string $cer, string $key, bool $xslt = false)
    {
        $this->cer = $cer;
        $this->key = $key;
        $this->xslt = $xslt;
     ...
     * @param boolean   $xslt
     */
    public function __construct1(array $data, string $cer, string $key, bool $xslt = false)
    {
    ...
    /**
     * Add data for generation of CFDI.
     *
     * @param array     $data
     *
     * @return void
     */
    public function addData(array $data, bool $xslt = false)
    {
        $this->comprobante = new Comprobante($data, $this->version);
    }
    ...
    public function getCadenaOriginal(): string
    {
        ...
        if ($this->xslt) {
            $path = './libs/CFDI/Utils/cadenaoriginal_3_3.xslt';
